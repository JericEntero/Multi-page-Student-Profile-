...
- Semantic HTML elements (header, nav, main, section, article and footer)
- Profile picture with descriptive alt text
- List the organization of a hobby with the `ul` and `li` elements:
